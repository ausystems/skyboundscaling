...
(function(){
'use strict';
/* First move: drop the no-js state. This runs deferred, so until this file
   arrives the page renders fully visible (fast LCP, works with JS blocked);
   reveals below re-hide and animate only once the runtime is actually here. */
...
/* ---------- Scroll reveals ----------
   ...
   scope on purpose - the hero intro timeline in home.js reveals those. */
